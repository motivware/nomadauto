    ...
    connect() {
      if (this.hasItemTarget) {
        ...
        sortable.on("sortable:start", function(event) {
          event.dragEvent.source.querySelectorAll(".draggable-mirror").setAttribute("style", "display: none;");
          console.log(event.dragEvent.sourceContainer.querySelectorAll(".draggable-mirror").setAttribute("style", "display: none;"));
        });
