...
vehicles_list = [
  ...
  ['1GNKVFED0HJ335214', 'Chevrolet', 'Traverse', 'General Motors', '2007', '90,000', 'V6, 3.6L; DOHC; 24V; DI', '',
   'Automatic', 1],
  ['1GNKVFED0HJ335214', 'Dodge', 'Dakota', 'Dodge', '2019', '10,000', 'V6, 3.6L; DOHC; 24V; DI', '', 'Automatic', 1],
  ['1GNKVFED0HJ335524', 'Chevrolet', 'Malibu', 'General Motors', '2000', '10,000', 'V6, 3.6L; DOHC; 24V; DI', '',
   'Automatic', 1],
  ...
  ['1GNKVFED0HJ331274', 'Toyota', 'Outlander', 'Toyota', '2008', '50,000', 'V6, 3.6L; DOHC; 24V; DI', '', 'Automatic',
   1],
